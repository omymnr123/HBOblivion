...
namespace net {
	...
	struct HB_PACKED PacketRequestEnchantAction : packet_base {
		PacketHeader header;
		uint16_t action_type; // e.g. EnchantShard, EnchantFragment, EnchantItem, DisenchantItem, ReqRecoverItem, ReqDepositMaterials
		int32_t inventory_slot;
		int32_t target_stat_id;
	};
	HB_PACK_END
}
}
