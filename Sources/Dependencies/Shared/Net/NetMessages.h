...
namespace CommonType
{
	enum : uint16_t
	{
		...
		// TESTER MENU â€” tester-only commands
		TesterAction                            = 0x0A76,
		TesterItemSearch                        = 0x0A77,
		TesterCreateItem                        = 0x0A78,
		TesterMapList                           = 0x0A79,
		GameMasterNpcSearch                     = 0x0A7B,
		ReqRecoverItem                          = 0x0A7C,
		ReqDepositMaterials                     = 0x0A7D,
		UpgradeShard                            = 0x0A7E,
		UpgradeFragment                         = 0x0A7F,
		UpgradeShardAll                         = 0x0A80,
		UpgradeFragmentAll                      = 0x0A81,
		WithdrawShard                           = 0x0A82,
		WithdrawFragment                        = 0x0A83,
		ReqRepairAll                            = 0x0F10,
...
namespace Notify
{
	enum : uint16_t
	{
		...
		// TESTER MENU â€” tester-only notifications
