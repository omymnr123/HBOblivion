...
constexpr int build_number = 520;
constexpr const char* stage = "alpha";
constexpr const char* display_version = "0.1.24-alpha";
constexpr const char* full_version = "0.1.24-alpha+build.520";
} // namespace server
...
constexpr int build_number = 610;
constexpr const char* stage = "alpha";
constexpr const char* display_version = "0.2.52-alpha";
constexpr const char* full_version = "0.2.52-alpha+build.610";
} // namespace client

constexpr const char* build_timestamp = "2026-08-05T16:39:20";
