...
constexpr int build_number = 321;
constexpr const char* stage = "alpha";
constexpr const char* display_version = "0.1.24-alpha";
constexpr const char* full_version = "0.1.24-alpha+build.321";
} // namespace server
...
constexpr const char* full_version = "0.2.52-alpha+build.436";
} // namespace client

constexpr const char* build_timestamp = "2026-07-28T10:40:46";
