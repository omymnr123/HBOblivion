...
constexpr int build_number = 549;
constexpr const char* stage = "alpha";
constexpr const char* display_version = "0.1.24-alpha";
constexpr const char* full_version = "0.1.24-alpha+build.549";
} // namespace server
...
constexpr int build_number = 636;
constexpr const char* stage = "alpha";
constexpr const char* display_version = "0.2.52-alpha";
constexpr const char* full_version = "0.2.52-alpha+build.636";
} // namespace client

constexpr const char* build_timestamp = "2026-08-06T11:22:37";
