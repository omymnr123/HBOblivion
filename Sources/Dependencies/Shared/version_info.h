...
constexpr int build_number = 584;
constexpr const char* stage = "alpha";
constexpr const char* display_version = "0.1.24-alpha";
constexpr const char* full_version = "0.1.24-alpha+build.584";
} // namespace server
...
constexpr int build_number = 644;
constexpr const char* stage = "alpha";
constexpr const char* display_version = "0.2.52-alpha";
constexpr const char* full_version = "0.2.52-alpha+build.644";
} // namespace client

constexpr const char* build_timestamp = "2026-08-08T22:37:40";
