...
constexpr int build_number = 521;
constexpr const char* stage = "alpha";
constexpr const char* display_version = "0.1.24-alpha";
constexpr const char* full_version = "0.1.24-alpha+build.521";
} // namespace server
...
constexpr int build_number = 612;
constexpr const char* stage = "alpha";
constexpr const char* display_version = "0.2.52-alpha";
constexpr const char* full_version = "0.2.52-alpha+build.612";
} // namespace client

constexpr const char* build_timestamp = "2026-08-05T17:59:31";
