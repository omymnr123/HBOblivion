...
constexpr const char* full_version = "0.1.24-alpha+build.381";
} // namespace server
...
constexpr const char* full_version = "0.2.52-alpha+build.468";
} // namespace client

constexpr const char* build_timestamp = "2026-08-01T16:07:40";
