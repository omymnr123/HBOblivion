...
constexpr const char* full_version = "0.1.24-alpha+build.322";
} // namespace server
...
constexpr int build_number = 437;
constexpr const char* stage = "alpha";
constexpr const char* display_version = "0.2.52-alpha";
constexpr const char* full_version = "0.2.52-alpha+build.437";
} // namespace client

constexpr const char* build_timestamp = "2026-07-28T13:20:19";
