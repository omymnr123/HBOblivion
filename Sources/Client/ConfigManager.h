...
public:
	...
	int get_tile_grid_color() const { return m_tile_grid_color; }
	void set_tile_grid_color(int color) { m_tile_grid_color = color; }
	bool is_tile_grid_trans() const { return m_tile_grid_trans; }
	void set_tile_grid_trans(bool trans) { m_tile_grid_trans = trans; }
...
private:
	...
	bool m_tile_grid;
	int m_tile_grid_color;
	bool m_tile_grid_trans;
