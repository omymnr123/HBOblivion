...
const DialogBox_GameMaster::action_entry DialogBox_GameMaster::actions[action_count] = {
	{ "Reset stats" },
...
DialogBox_GameMaster::DialogBox_GameMaster(CGame* game)
	: IDialogBox(DialogBoxId::GameMasterMenu, game)
{
	set_default_rect(0, 0, 258, 339);
	m_can_close_on_right_click = true;
}

int DialogBox_GameMaster::get_hovered_row(short sX, short sY, short mouse_x, short mouse_y, int count, int scroll) const
{
...
void DialogBox_GameMaster::draw_main_menu(short sX, short sY, short size_x)
{
...
void DialogBox_GameMaster::draw_level_picker(short sX, short sY, short size_x)
{
	short mouse_x = static_cast<short>(hb::shared::input::get_mouse_x());
	short mouse_y = static_cast<short>(hb::shared::input::get_mouse_y());
	// Title
...
void DialogBox_GameMaster::draw_teleport_page(short sX, short sY, short size_x)
{
	short mouse_x = static_cast<short>(hb::shared::input::get_mouse_x());
	short mouse_y = static_cast<short>(hb::shared::input::get_mouse_y());
	// Title
...
void DialogBox_GameMaster::on_draw()
{
	short mouse_x = static_cast<short>(hb::shared::input::get_mouse_x());
	short mouse_y = static_cast<short>(hb::shared::input::get_mouse_y());
...
bool DialogBox_GameMaster::on_click_main_menu(short sX, short sY)
{
	short mouse_x = static_cast<short>(hb::shared::input::get_mouse_x());
	short mouse_y = static_cast<short>(hb::shared::input::get_mouse_y());
...
bool DialogBox_GameMaster::on_click_level_picker(short sX, short sY)
{
	short mouse_x = static_cast<short>(hb::shared::input::get_mouse_x());
	short mouse_y = static_cast<short>(hb::shared::input::get_mouse_y());
	short size_x = m_size_x;
...
bool DialogBox_GameMaster::on_click_teleport(short sX, short sY)
{
	short mouse_x = static_cast<short>(hb::shared::input::get_mouse_x());
	short mouse_y = static_cast<short>(hb::shared::input::get_mouse_y());
	short size_x = m_size_x;
...
bool DialogBox_GameMaster::on_click()
{
	short mouse_x = static_cast<short>(hb::shared::input::get_mouse_x());
	short mouse_y = static_cast<short>(hb::shared::input::get_mouse_y());
	short sX = m_x;
...
void DialogBox_GameMaster::receive_map_list(const hb::net::PacketNotifyTesterMapListResult* pkt)
{
...
bool DialogBox_GameMaster::on_enable(int type, int64_t v1, int v2, const char* string)
{
