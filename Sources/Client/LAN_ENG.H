...
#define	_BDRAW_ON_CREATE_NEW_CHARACTER4	"Special stat points left: {}"
...
#define	ON_KEY_UP4	"Item({} {} {}) : set to [F2]"
#define	ON_KEY_UP5	"Magic({}) : set to [F2]"
...
#define	ON_KEY_UP15	"Item({} {} {}) : set to [F3]"
#define	ON_KEY_UP16	"Magic({}) : set to [F3]"
...
#define	ON_KEY_UP29	"Ability that decreases enemy's HP by 50%: Can be used after {} sec"
#define	ON_KEY_UP30	"Ability that freezes enemy: Can be used after {} sec"
#define	ON_KEY_UP31	"Ability that paralyzes enemy: Can be used after {} sec"
#define	ON_KEY_UP32	"Ability that kills enemy at one time: Can be used after {} sec"
#define	ON_KEY_UP33	"Ability that earns same HP as you decrease enemy's HP: Can use after {}Sec"
#define	ON_KEY_UP34	"Ability that exhausts enemy's weapon: Can be used after {} sec"
#define	ON_KEY_UP35	"Ability that protects from physical attack: Can be used after {} sec"
#define	ON_KEY_UP36	"Ability that makes character untouchable: Can be used after {} sec"

#define	ON_KEY_UP37	"Ability that decreases enemy's HP by 50%: Can be used after {} minutes"
#define	ON_KEY_UP38	"Ability that freezes enemy: Can be used after {} minutes"
#define	ON_KEY_UP39	"Ability that paralyzes enemy: Can be used after {} minutes"
#define	ON_KEY_UP40	"Ability that kills enemy at one time: Can be used after {} minutes"
#define	ON_KEY_UP41	"Ability that earns same HP as you decrease enemy's HP: Can use after {}Min"
#define	ON_KEY_UP42	"Ability that exhausts enemy's weapon: Can be used after {} minutes"
#define	ON_KEY_UP43	"Ability that protects from physical attack: Can be used after {} minutes"
#define	ON_KEY_UP44	"Ability that makes character untouchable: Can be used after {} minutes"
...
#define	UPDATE_SCREEN_ON_SELECT_CHARACTER7	"characters cannot be recovered."
#define	UPDATE_SCREEN_ON_SELECT_CHARACTER8	"You also cannot delete a character"
#define	UPDATE_SCREEN_ON_SELECT_CHARACTER9	"above level 50. If you want to"
#define	UPDATE_SCREEN_ON_SELECT_CHARACTER10	"delete a character above level 50,"
#define	UPDATE_SCREEN_ON_SELECT_CHARACTER11	"please send an e-mail to the game master."
...
#define	UPDATE_SCREEN_ON_SELECT_CHARACTER37	"Account validated till ({}/{}/{})"
#define	UPDATE_SCREEN_ON_SELECT_CHARACTER38	"Account use time left: {}D {}Hr {}Min"
#define	UPDATE_SCREEN_ON_SELECT_CHARACTER39	"It is not a registered account."
#define	UPDATE_SCREEN_ON_SELECT_CHARACTER40	"IP validity Time: {}Hr {}Min"
#define	UPDATE_SCREEN_ON_SELECT_CHARACTER41	"IP meter-rate term: {}D {}Hr {}Min"
#define	UPDATE_SCREEN_ON_SELECT_CHARACTER42	" "
#define	UPDATE_SCREEN_ON_SELECT_CHARACTER43	"Last Logout : {}/{}/{}  {} : {}"
...
#define	NOTIFY_MSG_HANDLER1	"{} joined the party."
#define	NOTIFY_MSG_HANDLER2	"{} withdrew from the party."
#define	NOTIFY_MSG_HANDLER3	"You can't move to other position for {} seconds except {}"
#define	NOTIFY_MSG_HANDLER4	"Use special ability!"

#define	NOTIFY_MSG_HANDLER5	"Decrease enemy's HP by 50%! Lasts {} seconds!"
#define	NOTIFY_MSG_HANDLER6	"Freeze enemy! Lasts {} seconds!"
#define	NOTIFY_MSG_HANDLER7	"Paralyze enemy! Lasts {} seconds!"
#define	NOTIFY_MSG_HANDLER8	"Kill enemy at once! Lasts {} seconds!"
#define	NOTIFY_MSG_HANDLER9	"Earn same HP as you decrease enemy's HP! During {}Sec!"
#define	NOTIFY_MSG_HANDLER10	"Exhaust enemy's weapon! Lasts {} seconds!"
#define	NOTIFY_MSG_HANDLER11	"Protect from physical attack! Lasts {} seconds!"
#define	NOTIFY_MSG_HANDLER12	"You are untouchable for {} seconds!"

#define	NOTIFY_MSG_HANDLER13	"Special ability has been set!"
#define	NOTIFY_MSG_HANDLER14	"Ability that decreases enemy's HP by 50%: Can use after {}Min"
#define	NOTIFY_MSG_HANDLER15	"Ability that freezes enemy: Can use after {}Min"
#define	NOTIFY_MSG_HANDLER16	"Ability that paralyzes enemy: Can use after {}Min"
#define	NOTIFY_MSG_HANDLER17	"Ability that kills enemy at one time: Can use after {}Min"
#define	NOTIFY_MSG_HANDLER18	"Ability that earns same HP as you decrease enemy's HP: Can use after {}Min"
#define	NOTIFY_MSG_HANDLER19	"Ability that exhausts enemy's weapon: Can use after {}Min"
#define	NOTIFY_MSG_HANDLER20	"Ability that protects from physical attack: Can use after {}Min"
#define	NOTIFY_MSG_HANDLER21	"Ability that makes character untouchable: Can use after {}Min"

#define	NOTIFY_MSG_HANDLER22	"Ability that decreases enemy's HP by 50%: Can use after {}Sec"
#define	NOTIFY_MSG_HANDLER23	"Ability that freezes enemy: Can use after {}Sec"
#define	NOTIFY_MSG_HANDLER24	"Ability that paralyzes enemy: Can use after {}Sec"
#define	NOTIFY_MSG_HANDLER25	"Ability that kills enemy at one time: Can use after {}Sec"
#define	NOTIFY_MSG_HANDLER26	"Ability that earns same HP as you decrease enemy's HP: Can use after {}Sec"
#define	NOTIFY_MSG_HANDLER27	"Ability that exhausts enemy's weapon: Can use after {}Sec"
#define	NOTIFY_MSG_HANDLER28	"Ability that protects from physical attack: Can use after {}Sec"
#define	NOTIFY_MSG_HANDLER29	"Ability that makes character untouchable: Can use after {}Sec"
...
#define	NOTIFY_MSG_HANDLER34	"{}(Aresden) pushed energy sphere to enemy's portal!!..."
#define	NOTIFY_MSG_HANDLER34_ELV	"{}(Elvine) pushed energy sphere to enemy's portal!!..."
#define	NOTIFY_MSG_HANDLER35	"Congulaturations! You brought energy sphere to portal and earned Contribution!"
#define	NOTIFY_MSG_HANDLER36	"Elvine {} : Goal in!"
#define	NOTIFY_MSG_HANDLER37	"Aresden {} : Goal in!"
#define	NOTIFY_MSG_HANDLER38	"Energy sphere was dropped in ({}, {}) of middleland!"
...
#define	UPDATE_SCREEN_ON_LOG_MSG35	"Block date: Until {}Y {}M {}D"
...
#define	RETIEVE_ITEM_HANDLER4	"You took out {}."


#define	ERASE_ITEM	"Item ({} {} {}) : has been released from hotkey [F{}]."
#define	ERASE_ITEM1	"Item ({} {} {}) : has been released from hotkey [F2]."
#define	ERASE_ITEM2	"Item ({} {} {}) : has been released from hotkey [F3]."


#define	BDLBBOX_DOUBLE_CLICK_INVENTORY1	"You can use after using the other item."
#define	BDLBBOX_DOUBLE_CLICK_INVENTORY3	"Item {}: Scrolls cannot be used until 10 seconds after taking damage."
...
#define	BDLBBOX_DOUBLE_CLICK_INVENTORY7	"Item {}: Select a position which you want to use."
#define	BDLBBOX_DOUBLE_CLICK_INVENTORY8	"Item {}: Select an item which you want to use."
...
#define	DLGBOX_CLICK_SYSMENU1	"Restarting game....{}"
...
#define	BCHECK_LOCAL_CHAT_COMMAND3	"Character {} has been listed on the message refusing list."
...
#define	NPC_TALK_HANDLER16	"Objective: slay {} {}"
#define	NPC_TALK_HANDLER17	"Location : Anywhere"
#define	NPC_TALK_HANDLER18	"Map : {}"
#define	NPC_TALK_HANDLER19	"Position: {},{} within {} blocks"
#define	NPC_TALK_HANDLER20	"Contribution:{}Points"
#define	NPC_TALK_HANDLER21	"Objective: Observe the enemy"
#define	NPC_TALK_HANDLER22	"Location : Anywhere"
#define	NPC_TALK_HANDLER23	"Map : {}"
#define	NPC_TALK_HANDLER24	"Position: {},{} within {} blocks"
#define	NPC_TALK_HANDLER25	"Contribution: {}Points"
...
#define	NPC_TALK_HANDLER32	"Teleport destination: {}"
...
#define	DRAW_DIALOGBOX_EXCHANGE33	"Please wait until {} agrees to"
...
#define	DRAW_DIALOGBOX_FISHING1	"Value: {} Gold"
...
#define	DRAW_DIALOGBOX_GUILDMENU32	"The price for the guild admission"
#define	DRAW_DIALOGBOX_GUILDMENU33	"ticket is {} Gold. Give it to the master"
#define	DRAW_DIALOGBOX_GUILDMENU34	"of the guild you want to join. He will"
#define	DRAW_DIALOGBOX_GUILDMENU35	"decide on your admission."
...
#define	DRAW_DIALOGBOX_GUILDMENU39	"ticket is {} Gold. Give it to the"
#define	DRAW_DIALOGBOX_GUILDMENU40	"Guildhall Officer to leave your guild."
#define	DRAW_DIALOGBOX_GUILDMENU41	"You will lose 300 experience points."
#define	DRAW_DIALOGBOX_GUILDMENU42	"Do you want to buy?"
#define	DRAW_DIALOGBOX_GUILDMENU43	"You bought a guild secession paper."

#define	DRAW_DIALOGBOX_GUILDMENU44	"It takes 1500 gold to make"
...
#define	DRAW_DIALOGBOX_GUILD_OPERATION3	"  You, Guildmaster, can decide whether"
...
#define	DRAW_DIALOGBOX_GUILD_OPERATION7	"* This player wants to leave your guild."
#define	DRAW_DIALOGBOX_GUILD_OPERATION8	"  You, Guildmaster, can decide whether"
#define	DRAW_DIALOGBOX_GUILD_OPERATION9	"  he can leave the guild or not."
#define	DRAW_DIALOGBOX_GUILD_OPERATION10	"Make a decision."

#define	DRAW_DIALOGBOX_GUILD_OPERATION11	"Approved! Joined the guild:"
#define	DRAW_DIALOGBOX_GUILD_OPERATION12	"* Your Guildmaster approved your"
#define	DRAW_DIALOGBOX_GUILD_OPERATION13	"request. You are now a guildsman."
...
#define	DRAW_DIALOGBOX_GUILD_OPERATION16	"refused your request."
#define	DRAW_DIALOGBOX_GUILD_OPERATION17	"Approved! Left the guild:"
#define	DRAW_DIALOGBOX_GUILD_OPERATION18	"* You have left the guild."
#define	DRAW_DIALOGBOX_GUILD_OPERATION19	"You are no longer a guildsman"
#define	DRAW_DIALOGBOX_GUILD_OPERATION20	"and are now a normal citizen."
...
#define	DRAW_DIALOGBOX_GUILD_OPERATION23	"refused your request."
...
#define	DRAW_DIALOGBOX_NOTICEMSG1	"You should find a safe place to logout."
...
#define DRAW_DIALOGBOX_NPCACTION_QUERY29	"{} {} to"
#define DRAW_DIALOGBOX_NPCACTION_QUERY29_1  "{}"
...
#define	DRAW_DIALOGBOX_PARTY16	"{} offered you to"
...
#define	DRAW_DIALOGBOX_PARTY26	"You asked {} to"
...
#define	DRAW_DIALOGBOX_QUERY_DROP_ITEM_AMOUNT1	" Dropping {}."
#define	DRAW_DIALOGBOX_QUERY_DROP_ITEM_AMOUNT2	"{}: give to {}."
#define	DRAW_DIALOGBOX_QUERY_DROP_ITEM_AMOUNT3	"Decide the quantity."
#define	DRAW_DIALOGBOX_QUERY_DROP_ITEM_AMOUNT4	"Dropping {}."
#define	DRAW_DIALOGBOX_QUERY_DROP_ITEM_AMOUNT5	"{}: give to {}."
...
#define	DRAW_DIALOGBOX_QUEST5	"Client: {}"
...
#define	DRAW_DIALOGBOX_QUEST29	"Client: {}"
#define	DRAW_DIALOGBOX_QUEST30	"Objective: Observe the enemy"
#define	DRAW_DIALOGBOX_QUEST31	"Location : Anywhere"
#define	DRAW_DIALOGBOX_QUEST32	"Map : {}"
#define	DRAW_DIALOGBOX_QUEST33	"Position: {}, {} Range: {} block"
#define	DRAW_DIALOGBOX_QUEST34	"Contribution: {}"
#define	DRAW_DIALOGBOX_QUEST35	"Your quest has been cancelled."



#define	DRAW_DIALOGBOX_SELL_LIST1  	"{} {}"
...
#define	DRAW_DIALOGBOX_SHOP15	"Available for above Str {}"
#define	DRAW_DIALOGBOX_SHOP16	"Available for above Dex {}"
#define	DRAW_DIALOGBOX_SHOP17	"Available for above Vit {}"
#define	DRAW_DIALOGBOX_SHOP18	"Available for above Int {}"
#define	DRAW_DIALOGBOX_SHOP19	"Available for above Mag {}"
#define	DRAW_DIALOGBOX_SHOP20	"Available for above Chr {}"
...
#define	DRAW_DIALOGBOX_SKILLDLG7	"Skill level: {}/{}"
...
#define	ITEM_EQUIPMENT_RELEASED	"Item {}: equipment has been released."
#define	BITEMDROP_CHARACTER9	"You equipped {}."
...
#define	NOTIFYMSG_CANNOT_GIVE_ITEM1	"{} {}: dropped to the ground. Unable to transfer to {}."
#define	NOTIFYMSG_CANNOT_GIVE_ITEM2	"{}: dropped to the ground. Unable to transfer to {}."


#define	NOTIFYMSG_THROW_ITEM1	"You threw {} {} away on the ground."
#define	NOTIFYMSG_THROW_ITEM2	"You threw the {} away on the ground."

#define	NOTIFYMSG_CANNOT_JOIN_MOREGUILDMAN1	"{} cannot join our guild."
#define	NOTIFYMSG_CANNOT_JOIN_MOREGUILDMAN2	"Guild is full."


#define	NOTIFYMSG_DISMISS_GUILDMAN1	"{} has withdrawn from our guild."


#define	NOTIFYMSG_CANNOT_RATING1	"You must be a friendly citizen to evaluate other players."
#define	NOTIFYMSG_CANNOT_RATING2	"You can evaluate other players after {} seconds."


#define	NOTIFYMSG_CANNOT_REPAIR_ITEM1	"Item {}: You don't have to repair this item."
#define	NOTIFYMSG_CANNOT_REPAIR_ITEM2	"Item {}: You can't repair this item here."



#define	NOTIFYMSG_CANNOT_SELL_ITEM1	"Item {}: You can't sell this item here."
#define	NOTIFYMSG_CANNOT_SELL_ITEM2	"Item {}: You can't sell an exhausted item."
#define	NOTIFYMSG_CANNOT_SELL_ITEM3	"Item {}: You can't sell this item."
...
#define	NOTIFYMSG_CHARISMA_UP	"CHR has been increased by {}points."
#define	NOTIFYMSG_CHARISMA_DOWN	"CHR has been decreased by {}points."


#define	NOTIFYMSG_DROPITEMFIN_ERASEITEM3	"You dropped a {}."
#define	NOTIFYMSG_DROPITEMFIN_ERASEITEM4	"You dropped {} {}."
#define	NOTIFYMSG_DROPITEMFIN_ERASEITEM5	"You dropped {}." // Snoopy


#define	NOTIFYMSG_ENEMYKILL_REWARD1	"You killed the enemy {}!"
#define	NOTIFYMSG_ENEMYKILL_REWARD2	"You killed the enemy {} of {} guild!"
#define	EXP_DECREASED	"Exp has been decreased by {}points."
#define	EXP_INCREASED	"Exp has been increased by {}points."
#define	NOTIFYMSG_ENEMYKILL_REWARD5	"Enemy-Kill-Count has been decreased by {}points."
#define	NOTIFYMSG_ENEMYKILL_REWARD6	"Enemy-Kill-Count has been increased by {}points."
...
#define	NOTIFYMSG_GIVEITEMFIN_COUNTCHANGED1	"You gave a {} to {}."
#define	NOTIFYMSG_GIVEITEMFIN_COUNTCHANGED2	"You gave {} {} to {}."


#define	NOTIFYMSG_GIVEITEMFIN_ERASEITEM2	"You dropped {} {}. unable to transfer."
#define	NOTIFYMSG_GIVEITEMFIN_ERASEITEM3	"You gave {} {} to Warehouse Keeper."
#define	NOTIFYMSG_GIVEITEMFIN_ERASEITEM4	"You gave {} {} to Guildhall Officer."
#define	NOTIFYMSG_GIVEITEMFIN_ERASEITEM5	"You gave {} {} to Cityhall Officer."
#define	NOTIFYMSG_GIVEITEMFIN_ERASEITEM6	"You gave {} {} to Sorcerer."
#define	NOTIFYMSG_GIVEITEMFIN_ERASEITEM7	"You gave {} {} to Blacksmith Keeper."
#define	NOTIFYMSG_GIVEITEMFIN_ERASEITEM8	"You gave {} {} to {}."
...
#define	NOTIFYMSG_ITEMCOLOR_CHANGE1	"You dyed {}."
#define	NOTIFYMSG_ITEMCOLOR_CHANGE2	"Item {}: can not be dyed."


#define	NOTIFYMSG_ITEMDEPlETED_ERASEITEM2	"Item {}: exhausted."
#define	NOTIFYMSG_ITEMDEPlETED_ERASEITEM3	"You used {}."
#define	NOTIFYMSG_ITEMDEPlETED_ERASEITEM4	"You ate {}."
#define	NOTIFYMSG_ITEMDEPlETED_ERASEITEM5	"You used {}."
...
#define	NOTIFYMSG_ITEMOBTAINED2	"You got a {}."


#define	NOTIFYMSG_ITEMPURCHASED	"You bought a {} with {} Gold."

#define	NOTIFYMSG_ITEMREPAIRED1	"Item {}: repaired."



#define	NOTIFYMSG_ITEMTOBANK2	"Item {} {}: put in safekeeping."
#define	NOTIFYMSG_ITEMTOBANK3	"Item {}: put in safekeeping."
...
#define	NOTIFYMSG_LEVELUP1	"Level up!!! Level {}!"
...
#define	NOTIFYMSG_MAGICSTUDY_FAIL3	"INT must be more than {} to learn."
// CLEROTH
#define	NOTIFYMSG_MAGICSTUDY_FAIL4	"Failed learning ({})! Cost:{}  Int:{}  Str:{}"

#define	NOTIFYMSG_MAGICSTUDY_SUCCESS1	"Magic({}): learned!"

#define	NOTIFYMSG_HP_UP	"HP has been increased by {}points."
#define	NOTIFYMSG_HP_DOWN	"HP has been decreased by {}points."
#define	NOTIFYMSG_MP_UP	"Your MP has been increased by {} points."
#define	NOTIFYMSG_MP_DOWN	"Your MP has been decreased by {} points."
#define	NOTIFYMSG_SP_UP	"SP has been increased by {} points."
#define	NOTIFYMSG_SP_DOWN	"SP has been decreased by {} points."
...
#define	NOTIFYMSG_NEW_GUILDMAN1	"{} has joined your guild."


#define	NOTIFYMSG_PK_CAPTURED1	"Level {} win in a battle against the Criminal {}({})!"
#define	NOTIFYMSG_PK_CAPTURED3	"You can receive {} prize gold."


#define	NOTIFYMSG_PK_PENALTY1	"You received a PK penalty because you killed an innocent player! PK-Count({})"
#define	NOTIFYMSG_PK_PENALTY2	"Exp has been decreased by {} points!"

#define	NOTIFYMSG_PLAYER_SHUTUP1	"You got a penalty that you can't chat for {}seconds"
#define	NOTIFYMSG_PLAYER_SHUTUP2	"You gave {} a penalty that he can't chat for {}seconds."


#define	NOTIFYMSG_PLAYER_STATUS1	"Player {} is connected to the game server."
#define	NOTIFYMSG_PLAYER_STATUS2	"Player {} is connected to the {}({} {})."
#define	NOTIFYMSG_PLAYER_STATUS3    "Player {} is not connected to the game server"


#define	NOTIFYMSG_QUEST_REWARD1	"Prize: Experience {} points"
#define	NOTIFYMSG_QUEST_REWARD2	"Prize: {} {}"
#define	NOTIFYMSG_QUEST_REWARD3	"Contribution ascent to {} points."
#define	NOTIFYMSG_QUEST_REWARD4	"Contribution descent to {} points."


#define	NOTIFYMSG_RATING_PLAYER1	"Another player gave you a good evaluation."
#define	NOTIFYMSG_RATING_PLAYER2	"You gave a good evaluation to {}!"
#define	NOTIFYMSG_RATING_PLAYER3	"You gave a bad evaluation to {}!"
...
#define	NOTIFYMSG_TOTAL_USER1	"Total players connected: {}."


#define	NOTIFYMSG_WHISPERMODE1	"Whispering mode set with {}."
...
#define	INITDATA_RESPONSE_HANDLER1	"This is {}."
...
#define	DRAW_DIALOGBOX_CONSTRUCTOR1	"Construction location: {} near {},{}"
...
#define	DRAW_DIALOGBOX_SOLDIER1	"Teleport position: {} near {}, {}"
...
#define NOTIFYMSG_CREATE_SCREENSHOT1 "Screenshot saved to {}."
...
#define DRAW_DIALOGBOX_ITEMUPGRADE11 "Item upgrade point : {}"
#define DRAW_DIALOGBOX_ITEMUPGRADE12 "Needed upgrade point : {}"
...
#define DRAW_DIALOGBOX_ITEMUPGRADE34 "The number of upgrade(weapon): {}"
#define DRAW_DIALOGBOX_ITEMUPGRADE35 "The number of upgrade(armor): {}"
...
#define	MSG_SHORTCUT2	" To Equip an item, weapon, or magic in the F{} Key"
#define	MSG_SHORTCUT3	" Cast a spell first then press the [control]-[F{}] to set as a hotkey"
#define	MSG_SHORTCUT4	"Item({} {} {}) : set to [F{}]."
#define	MSG_SHORTCUT5	"Magic({}) : set to [F{}]."
