...
CMapData::CMapData(class CGame* game)
{
	...
	m_stFrame[hb::shared::owner::ForgottenSealedTomb][Type::stop].m_sFrameTime = 250;
	m_stFrame[hb::shared::owner::ForgottenSealedTomb][Type::stop].m_sMaxFrame = 0;
	m_stFrame[hb::shared::owner::ForgottenSealedTomb][Type::Move].m_sFrameTime = 60;
	m_stFrame[hb::shared::owner::ForgottenSealedTomb][Type::Move].m_sMaxFrame = 0;
	m_stFrame[hb::shared::owner::ForgottenSealedTomb][Type::Attack].m_sFrameTime = 120;
	m_stFrame[hb::shared::owner::ForgottenSealedTomb][Type::Attack].m_sMaxFrame = 3;
	m_stFrame[hb::shared::owner::ForgottenSealedTomb][Type::Damage].m_sFrameTime = 150;
	m_stFrame[hb::shared::owner::ForgottenSealedTomb][Type::Damage].m_sMaxFrame = 0;
	m_stFrame[hb::shared::owner::ForgottenSealedTomb][Type::Dying].m_sFrameTime = 200;
	m_stFrame[hb::shared::owner::ForgottenSealedTomb][Type::Dying].m_sMaxFrame = 0;

	m_stFrame[hb::shared::owner::AncientSealedTomb][Type::stop].m_sFrameTime = 250;
	m_stFrame[hb::shared::owner::AncientSealedTomb][Type::stop].m_sMaxFrame = 0;
	m_stFrame[hb::shared::owner::AncientSealedTomb][Type::Move].m_sFrameTime = 60;
	m_stFrame[hb::shared::owner::AncientSealedTomb][Type::Move].m_sMaxFrame = 0;
	m_stFrame[hb::shared::owner::AncientSealedTomb][Type::Attack].m_sFrameTime = 120;
	m_stFrame[hb::shared::owner::AncientSealedTomb][Type::Attack].m_sMaxFrame = 3;
	m_stFrame[hb::shared::owner::AncientSealedTomb][Type::Damage].m_sFrameTime = 150;
	m_stFrame[hb::shared::owner::AncientSealedTomb][Type::Damage].m_sMaxFrame = 0;
	m_stFrame[hb::shared::owner::AncientSealedTomb][Type::Dying].m_sFrameTime = 200;
	m_stFrame[hb::shared::owner::AncientSealedTomb][Type::Dying].m_sMaxFrame = 0;

	m_stFrame[hb::shared::owner::PrimordialSealedTomb][Type::stop].m_sFrameTime = 250;
	m_stFrame[hb::shared::owner::PrimordialSealedTomb][Type::stop].m_sMaxFrame = 0;
	m_stFrame[hb::shared::owner::PrimordialSealedTomb][Type::Move].m_sFrameTime = 60;
	m_stFrame[hb::shared::owner::PrimordialSealedTomb][Type::Move].m_sMaxFrame = 0;
	m_stFrame[hb::shared::owner::PrimordialSealedTomb][Type::Attack].m_sFrameTime = 120;
	m_stFrame[hb::shared::owner::PrimordialSealedTomb][Type::Attack].m_sMaxFrame = 3;
	m_stFrame[hb::shared::owner::PrimordialSealedTomb][Type::Damage].m_sFrameTime = 150;
	m_stFrame[hb::shared::owner::PrimordialSealedTomb][Type::Damage].m_sMaxFrame = 0;
	m_stFrame[hb::shared::owner::PrimordialSealedTomb][Type::Dying].m_sFrameTime = 200;
	m_stFrame[hb::shared::owner::PrimordialSealedTomb][Type::Dying].m_sMaxFrame = 0;
...
bool CMapData::set_owner(uint16_t object_id, int sX, int sY, int type, direction dir, const hb::shared::entity::PlayerAppearance& appearance, const hb::shared::entity::PlayerStatus& status, std::string& name, short action, short v1, short v2, short v3, int pre_loc, int frame, short npcConfigId)
{
	...
	if (pre_loc == 0)
	{
		...
		if (action == Type::Damage || action == Type::DamageMove) {
			localStatus.hp_percent = static_cast<uint8_t>(v2);
		}
			...
			if (m_data[dX][dY].m_owner_type != 0)
			{
				...
				if (m_data[dX][dY].m_animation.update(time))
				{
					...
					if (m_data[dX][dY].m_animation.m_action == Type::stop) { // Type::stop = 1 // 00497334
						...
						case hb::shared::owner::ForgottenSealedTomb:
						case hb::shared::owner::AncientSealedTomb:
						case hb::shared::owner::PrimordialSealedTomb:
							if ((rand() % 40) == 25)
							{
