...
public:
	...
	// Sarcofago Minimap Marker
	short m_sarcofago_x = 0;
	short m_sarcofago_y = 0;
	uint8_t m_sarcofago_id = 0;
...
std::array<bool, hb::shared::limits::MaxItems> m_is_item_equipped{};
	...
	uint8_t m_secondary_multiplier[64]{};
