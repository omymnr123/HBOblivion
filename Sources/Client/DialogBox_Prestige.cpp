...
void DialogBox_Prestige::on_draw()
{
	...
	hb::shared::text::draw_text_aligned(GameFont::Default, sX, sY + 90, (sX + size_x) - sX, 15, "Are you ready to transcend?", hb::shared::text::TextStyle::from_color(GameColors::UIWhite), hb::shared::text::Align::TopCenter);
	
	hb::shared::text::draw_text_aligned(GameFont::Default, sX, sY + 115, (sX + size_x) - sX, 15, "Warning: Your Level will be reset to 1.", hb::shared::text::TextStyle::from_color(GameColors::UIRed), hb::shared::text::Align::TopCenter);
	hb::shared::text::draw_text_aligned(GameFont::Default, sX, sY + 130, (sX + size_x) - sX, 15, "Leveling up will become 15% harder.", hb::shared::text::TextStyle::from_color(GameColors::UIRed), hb::shared::text::Align::TopCenter);
	
	hb::shared::text::draw_text_aligned(GameFont::Default, sX, sY + 160, (sX + size_x) - sX, 15, "In return, you will gain +3 Stat Points", hb::shared::text::TextStyle::from_color(GameColors::UIGreen), hb::shared::text::Align::TopCenter);
	hb::shared::text::draw_text_aligned(GameFont::Default, sX, sY + 175, (sX + size_x) - sX, 15, "permanently to distribute as you wish.", hb::shared::text::TextStyle::from_color(GameColors::UIGreen), hb::shared::text::Align::TopCenter);

	// Mostrar requisitos
	hb::shared::text::draw_text_aligned(GameFont::Default, sX, sY + 210, (sX + size_x) - sX, 15, "Requirements:", hb::shared::text::TextStyle::from_color(GameColors::UILabel), hb::shared::text::Align::TopCenter);
	hb::shared::text::draw_text_aligned(GameFont::Default, sX, sY + 225, (sX + size_x) - sX, 15, "- Reach Level 180", hb::shared::text::TextStyle::from_color(GameColors::UIMagicBlue), hb::shared::text::Align::TopCenter);
	hb::shared::text::draw_text_aligned(GameFont::Default, sX, sY + 240, (sX + size_x) - sX, 15, "- Weight under 50", hb::shared::text::TextStyle::from_color(GameColors::UIMagicBlue), hb::shared::text::Align::TopCenter);
