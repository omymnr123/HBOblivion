...
bool DialogBox_Inventory::on_double_click()
{
	...
	// Enchanting dialog
	else if (m_game->get_dialog_box_manager().is_enabled(DialogBoxId::Enchanting))
	{
		m_game->get_dialog_box_manager().get_dialog_box(DialogBoxId::Enchanting)->on_item_drop();
		return true;
	}
